...
import * as tt from './telegram_types'

import {Telegram} from 'telegraf/typings/telegram'
import I18n from "telegraf-i18n";
import {Either} from "../fp/f_p";
import {Failure, Success} from "../abstracts";

/*import SceneContextScene, {SceneSession} from "telegraf/src/scenes/context";
import WizardContextWizard from "telegraf/src/scenes/wizard/context";*/
...
export declare class TelegrafContext {
    ...
    replyWithPhoto(
        photo: tt.InputFile,
        extra?: tt.ExtraPhoto
    ): Promise<Either<Failure, Success<tt.MessagePhoto>>>
